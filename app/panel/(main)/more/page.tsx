...
import { useLogout } from "@/lib/apis";

export default function MoreMenu() {
  const pathname = usePathname();

  return <MoreMenuContent key={pathname} />;
}
...
function MoreMenuContent() {
  ...
  return (
    <>
      <main dir="rtl" className="w-full max-w-[700px] mx-auto px-4 py-6">
        <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold">مالی</span>
              </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold">مشاور فروش</span>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold">پیش‌نویس‌ها</span>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold">اتصال حساب اینستاگرام</span>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold">محصولات رد شده</span>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold">حساب من</span>
            </div>
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold">راهنما</span>
              </div>
